  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen name='AddAddresses' component={AddAddresses} options={{headerShown: false}} />
        <Stack.Screen name='OrderSucces' component={OrderSucces} options={{headerShown: false}} />
